...
void toolPanel::createPhisicTab(){
    ...
    rigidBodiesBar=new dTabBar(phisicTabWidget);
    constraintsBar=new dTabBar(phisicTabWidget);
...
void toolPanel::createLODsTab(){
    ...
    LOD0Tab=new dTabBar(LODsTab);
    LOD1Tab=new dTabBar(LODsTab);
    LOD2Tab=new dTabBar(LODsTab);
    LOD3Tab=new dTabBar(LODsTab);
