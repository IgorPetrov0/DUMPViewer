...
#include "../../DUMPViewer/viewwindow.h"
...
const QMetaObject viewWindow::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_viewWindow.data,
...
void *viewWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions_3_3_Core"))
        return static_cast< QOpenGLFunctions_3_3_Core*>(const_cast< viewWindow*>(this));
