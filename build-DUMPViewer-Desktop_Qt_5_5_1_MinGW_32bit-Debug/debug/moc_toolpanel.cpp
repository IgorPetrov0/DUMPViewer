...
void toolPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (toolPanel::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&toolPanel::openPhisicMesh)) {
                *result = 0;
            }
        }
        {
            typedef void (toolPanel::*_t)(QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&toolPanel::openGraphicMesh)) {
                *result = 1;
            }
        }
        {
            typedef void (toolPanel::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&toolPanel::showHidePhisicMesh)) {
                *result = 2;
            }
        }
        {
            typedef void (toolPanel::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&toolPanel::showHideGraphicMesh)) {
                *result = 3;
            }
        }
        {
            typedef void (toolPanel::*_t)(float , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&toolPanel::setLODDistance)) {
                *result = 4;
            }
        }
        {
            typedef void (toolPanel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&toolPanel::moveMeshToDistance)) {
                *result = 5;
            }
        }
        {
            typedef void (toolPanel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&toolPanel::returnLastDistance)) {
                *result = 6;
            }
        }
    }
...
const QMetaObject toolPanel::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_toolPanel.data,
      qt_meta_data_toolPanel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
