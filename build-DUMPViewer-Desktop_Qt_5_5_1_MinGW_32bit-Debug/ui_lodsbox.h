...
public:
    ...
    {
        lodsBox->setWindowTitle(QApplication::translate("lodsBox", "Form", 0));
        groupBox->setTitle(QApplication::translate("lodsBox", "LODs", 0));
        groupLOD1->setTitle(QApplication::translate("lodsBox", "LOD 1", 0));
        loadButton->setText(QApplication::translate("lodsBox", "Load", 0));
        label->setText(QApplication::translate("lodsBox", "Distance", 0));
        showCheckBox->setText(QApplication::translate("lodsBox", "Show", 0));
        distButton->setText(QApplication::translate("lodsBox", "Dist", 0));
        groupLOD2->setTitle(QApplication::translate("lodsBox", "LOD 2", 0));
        loadButton_2->setText(QApplication::translate("lodsBox", "Load", 0));
        label_2->setText(QApplication::translate("lodsBox", "Distance", 0));
        showCheckBox_2->setText(QApplication::translate("lodsBox", "Show", 0));
        distButton_2->setText(QApplication::translate("lodsBox", "Dist", 0));
        groupLOD3->setTitle(QApplication::translate("lodsBox", "LOD 3", 0));
        loadButton_4->setText(QApplication::translate("lodsBox", "Load", 0));
        label_4->setText(QApplication::translate("lodsBox", "Distance", 0));
        showCheckBox_4->setText(QApplication::translate("lodsBox", "Show", 0));
        distButton_4->setText(QApplication::translate("lodsBox", "Dist", 0));
    } // retranslateUi
