...
public:
    ...
    {
        toolWidget->setWindowTitle(QApplication::translate("toolWidget", "Form", 0));
        phisicTab->setTabText(phisicTab->indexOf(rigidBodiesTabBar), QApplication::translate("toolWidget", "Rigid bodies", 0));
        phisicTab->setTabText(phisicTab->indexOf(constraintsTabBar), QApplication::translate("toolWidget", "Constraints", 0));
        tabWidget->setTabText(tabWidget->indexOf(phisicTabWidget), QApplication::translate("toolWidget", "Phisic", 0));
        graphicTab->setTabText(graphicTab->indexOf(meshTabBar), QApplication::translate("toolWidget", "Mesh", 0));
        groupBox->setTitle(QApplication::translate("toolWidget", "Error", 0));
        label->setText(QApplication::translate("toolWidget", "Please define previous LOD befor ", 0));
        label_2->setText(QApplication::translate("toolWidget", "created new.", 0));
        graphicTab->setTabText(graphicTab->indexOf(plusLODTabBar), QApplication::translate("toolWidget", "Add LOD", 0));
        showRadioButton->setText(QApplication::translate("toolWidget", "Show graphic", 0));
        tabWidget->setTabText(tabWidget->indexOf(graphicTabWidget), QApplication::translate("toolWidget", "Graphic", 0));
    } // retranslateUi
