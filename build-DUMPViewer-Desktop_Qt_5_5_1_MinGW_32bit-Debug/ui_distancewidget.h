...
public:
    ...
    {
        distanceWidget->setWindowTitle(QApplication::translate("distanceWidget", "Form", 0));
        groupBox->setTitle(QApplication::translate("distanceWidget", "Distance", 0));
        moveButton->setText(QApplication::translate("distanceWidget", "Move to distance", 0));
    } // retranslateUi
