...
public:
    ...
    {
        hingeWidget->setWindowTitle(QApplication::translate("hingeWidget", "Form", 0));
        useReferenceACheckBox->setText(QApplication::translate("hingeWidget", "Use reference A", 0));
        useReferenceBCheckBox->setText(QApplication::translate("hingeWidget", "Use reference B", 0));
    } // retranslateUi
