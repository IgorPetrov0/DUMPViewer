...
void LODTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (LODTab::*_t)(unsigned int , unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LODTab::deleteSignal)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject LODTab::staticMetaObject = {
    { &dTabBar::staticMetaObject, qt_meta_stringdata_LODTab.data,
      qt_meta_data_LODTab,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LODTab::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LODTab.stringdata0))
        return static_cast<void*>(const_cast< LODTab*>(this));
