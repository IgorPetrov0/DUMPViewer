...
#include "../../DUMPViewer/GUI/infobox.h"
...
const QMetaObject infoBox::staticMetaObject = {
    { &dumpViewerWidget::staticMetaObject, qt_meta_stringdata_infoBox.data,
      qt_meta_data_infoBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *infoBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_infoBox.stringdata0))
        return static_cast<void*>(const_cast< infoBox*>(this));
