...
void dTabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (dTabBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dTabBar::changeSygnal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject dTabBar::staticMetaObject = {
    { &QTabBar::staticMetaObject, qt_meta_stringdata_dTabBar.data,
      qt_meta_data_dTabBar,  qt_static_metacall, nullptr, nullptr}
};
