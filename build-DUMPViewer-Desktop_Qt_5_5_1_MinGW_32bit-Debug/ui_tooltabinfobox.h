...
public:
    ...
    {
        toolTabInfoBox->setWindowTitle(QApplication::translate("toolTabInfoBox", "Form", 0));
        meshGroup->setTitle(QApplication::translate("toolTabInfoBox", "Mesh", 0));
        fileNameLine->setText(QString());
        loadButton->setText(QApplication::translate("toolTabInfoBox", "Load", 0));
        deleteButton->setText(QApplication::translate("toolTabInfoBox", "Delete", 0));
    } // retranslateUi
